...
/**
 * 
 * @ClassName: MethodParametersTools
 * @Description: 获取方法的参数名称
 * @author mengyunjuan 于 2013-8-14 上午11:50:20
 */
public class MethodParametersTools {
	...
	public static void main(String[] args) {
		//Method[] methods = UserAction.class.getDeclaredMethods();
